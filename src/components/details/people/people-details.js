...
const PeopleDetails = ({toggleInterestsModal, toggleFollowerModal, toggleFollowingModal, toggleClientsModal}) => {
            ...
            </div>
            {
                ...
                <div className="stockmeister-user-info bg-light">
                    <PeopleInfocard data={userInfo}
                                    clientsModal={toggleClientsModal}
                                    followingModal={toggleFollowingModal}
